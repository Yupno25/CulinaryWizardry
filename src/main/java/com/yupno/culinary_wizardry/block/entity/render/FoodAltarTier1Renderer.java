...
public class FoodAltarTier1Renderer implements BlockEntityRenderer<FoodAltarTier1BlockEntity> {
    ...
    @Override
    public void render(FoodAltarTier1BlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
