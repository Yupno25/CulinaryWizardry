...
public class FoodAltarTier4Renderer implements BlockEntityRenderer<FoodAltarTier4BlockEntity> {
    ...
    @Override
    public void render(FoodAltarTier4BlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
