...
public class SubAltarRenderer implements BlockEntityRenderer<SubAltarBlockEntity> {
    ...
    private final CauldronQuad quad = new CauldronQuad((float)8 / 2); /** Size of fluid texture */
    private int rotationDegrees = 0;

    public SubAltarRenderer(BlockEntityRendererProvider.Context context){
    }
    @Override
    public void render(SubAltarBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
