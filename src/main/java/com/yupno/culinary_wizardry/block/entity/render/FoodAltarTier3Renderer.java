...
public class FoodAltarTier3Renderer implements BlockEntityRenderer<FoodAltarTier3BE> {
    /**
    ...
    @Override
    public void render(@NotNull FoodAltarTier3BE pBlockEntity, float pPartialTick, @NotNull PoseStack pPoseStack,
