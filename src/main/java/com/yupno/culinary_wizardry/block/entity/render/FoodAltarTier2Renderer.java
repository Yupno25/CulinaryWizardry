...
public class FoodAltarTier2Renderer implements BlockEntityRenderer<FoodAltarTier2BlockEntity> {
    ...
    @Override
    public void render(FoodAltarTier2BlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
