...
public class FoodAltarTier2Menu extends BaseFoodAltarMenu {
    private final FoodAltarTier2BE blockEntity;
    ...
    public FoodAltarTier2Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FOOD_ALTAR_TIER2_MENU.get(), pContainerId, 6, inv, entity, data);
        this.level = inv.player.level;
        blockEntity = ((FoodAltarTier2BE) entity);
    }
