...
public class FoodAltarTier1Menu extends AbstractContainerMenu {
    private final FoodAltarTier1BlockEntity blockEntity;
    ...
    public FoodAltarTier1Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FOOD_ALTAR_TIER1_MENU.get(), pContainerId);
        checkContainerSize(inv, 6);
        blockEntity = ((FoodAltarTier1BlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FOOD_ALTAR_TIER1.get()) && blockEntity.isFullAltarShape();
    }
