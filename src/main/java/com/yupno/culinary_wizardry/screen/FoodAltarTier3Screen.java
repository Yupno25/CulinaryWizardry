...
public class FoodAltarTier3Screen extends AbstractContainerScreen<FoodAltarTier3Menu> {
    ...
    public FoodAltarTier3Screen(FoodAltarTier3Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
