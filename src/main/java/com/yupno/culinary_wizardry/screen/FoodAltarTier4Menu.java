...
public class FoodAltarTier4Menu extends AbstractContainerMenu {
    private final FoodAltarTier4BlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public FoodAltarTier4Menu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(13));
    }

    public FoodAltarTier4Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FOOD_ALTAR_TIER4_MENU.get(), pContainerId);
        checkContainerSize(inv, 6);
        blockEntity = ((FoodAltarTier4BlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FOOD_ALTAR_TIER4.get()) && blockEntity.isFullAltarShape();
    }
