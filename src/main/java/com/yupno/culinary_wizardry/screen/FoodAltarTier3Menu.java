...
public class FoodAltarTier3Menu extends AbstractContainerMenu {
    private final FoodAltarTier3BlockEntity blockEntity;
    ...
    public FoodAltarTier3Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FOOD_ALTAR_TIER3_MENU.get(), pContainerId);
        checkContainerSize(inv, 6);
        blockEntity = ((FoodAltarTier3BlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FOOD_ALTAR_TIER3.get()) && blockEntity.isFullAltarShape();
    }
