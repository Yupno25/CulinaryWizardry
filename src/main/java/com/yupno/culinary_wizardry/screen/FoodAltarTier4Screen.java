...
public class FoodAltarTier4Screen extends AbstractContainerScreen<FoodAltarTier4Menu> {
    ...
    public FoodAltarTier4Screen(FoodAltarTier4Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
